...
/***/78:
/***/function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var r=l(n(12)),o=l(n(77)),a=l(n(0)),i=l(n(6)),u=n(2);function l(e){return e&&e.__esModule?e:{default:e}}t.default=function(e,t,n,l){OvenPlayerConsole.log("CORE loaded. ");var s={};(0,r.default)(s);var d=function(e,t){return a.default.isElement(t)?t:e===u.PROVIDER_DASH?t.getVideoElement():e===u.PROVIDER_HLS?t.media:null}(e,t),c=(0,o.default)(e,t,d,s),g=!1,E=!1,f=u.STATE_IDLE,v=0,T=-1,y=[],O=n.getConfig().image||"";d.playbackRate=d.defaultPlaybackRate=n.getDefaultPlaybackRate();var m=function(e){var t=Math.max(0,T);if(e)for(var r=0;r<e.length;r++)if(e[r].default&&(t=r),n.getQualityLabel()&&e[r].label===n.getQualityLabel())return r;return t},p=function(e){var t=y[T];if(l)l(t,e);else{OvenPlayerConsole.log("source loaded : ",t,"lastPlayPosition : "+e);var n=d.src,r=document.createElement("source");r.src=t.file,r.src!==n?(d.src=y[T].file,
// Do not call load if src was not set. load() will cancel any active play promise.
n&&d.load()):0==e&&d.currentTime>0&&s.seek(e),e>0&&(s.seek(e),s.play()),s.trigger(u.CONTENT_LEVELS,{currentQuality:T}),O&&(d.poster=O)}};return s.getName=function(){return e},s.canSeek=function(){return g},s.setCanSeek=function(e){g=e},s.isSeeking=function(){return E},s.setSeeking=function(e){E=e},s.setState=function(e){if(f!=e){var t=f;switch(e){case u.STATE_COMPLETE:s.trigger(u.PLAYER_COMPLETE);break;case u.STATE_PAUSED:s.trigger(u.PLAYER_PAUSE,{prevState:f});break;case u.STATE_PLAYING:s.trigger(u.PLAYER_PLAY,{prevState:f})}f=e,s.trigger(u.PLAYER_STATE,{prevstate:t,newstate:f})}},s.getState=function(){return f},s.setBuffer=function(e){v=e},s.getBuffer=function(){return v},s.getDuration=function(){return d.duration==1/0||e===u.PROVIDER_DASH&&t.isDynamic()?1/0:d.duration},s.getPosition=function(){return d.currentTime},s.setVolume=function(e){d.volume=e/100},s.getVolume=function(){return 100*d.volume},s.setMute=function(e){return void 0===e?(d.muted=!d.muted,s.trigger(u.CONTENT_MUTE,{mute:d.muted})):(d.muted=e,s.trigger(u.CONTENT_MUTE,{mute:d.muted})),d.muted},s.getMute=function(){return d.muted},s.preload=function(e,t){return T=m(y=e),p(t||0),new i.default(function(e,t){e()})},s.load=function(e){T=m(y=e),p(e.starttime||0)},s.play=function(){s.getState()!==u.STATE_PLAYING&&d.play()},s.pause=function(){s.getState()==u.STATE_PLAYING&&d.pause()},s.seek=function(e){d.currentTime=e},s.setPlaybackRate=function(e){return s.trigger(u.PLAYBACK_RATE_CHANGED,{playbackRate:e}),d.playbackRate=d.defaultPlaybackRate=e},s.getPlaybackRate=function(){return d.playbackRate},s.getQualityLevels=function(){return y.map(function(e,t){return{file:e.file,type:e.type,label:e.label,index:t}})},s.getCurrentQuality=function(){var e=y[T];return{file:e.file,type:e.type,label:e.label,index:T}},s.setCurrentQuality=function(e,t){return T!=e&&(e>-1&&y&&y.length>e?(
//that.pause();
