...
if(n.trigger(e,t),e===c.ERROR&&(t.code===c.PLAYER_FILE_ERROR||5===parseInt(t.code/100))||e===c.NETWORK_UNSTABLED){var r=n.getCurrentQuality();r+1<n.getQualityLevels().length&&(
//this sequential has available source.
n.pause(),n.setCurrentQuality(r+1))}})}).then(function(){h.preload(p.getCurrentSources(),e),g.flush(),
...
//2018.07.17 hslee
t.on("unstableNetwork",function(e){var n="Because the network connection is unstable, the following media source will be played.";t.getCurrentQuality()+1===t.getQualityLevels().length&&(n="Network connection is unstable. Check the network connection."),l(n,5e3)})}},
/* 47 */
