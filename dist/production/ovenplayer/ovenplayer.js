...
g.each=g.forEach=function(e,t,n){var r,o;if(t=b(t,n),O(e))for(r=0,o=e.length;r<o;r++)t(e[r],r,e);else{var i=g.keys(e);for(r=0,o=i.length;r<o;r++)t(e[i[r]],i[r],e)}return e},
// Return the results of applying the iteratee to each element.
g.map=g.collect=function(e,t,n){t=x(t,n);for(var r=!O(e)&&g.keys(e),o=(r||e).length,i=Array(o),a=0;a<o;a++){var u=r?r[a]:a;i[a]=t(e[u],u,e)}return i};
// Create a reducing function iterating left or right.
var k=function(e){return function(t,n,r,o){var i=arguments.length>=3;return function(t,n,r,o){var i=!O(t)&&g.keys(t),a=(i||t).length,u=e>0?0:a-1;for(o||(r=t[i?i[u]:u],u+=e);u>=0&&u<a;u+=e){var s=i?i[u]:u;r=n(r,t[s],s,t)}return r}(t,b(n,o,4),r,i)}};
// **Reduce** builds up a single result from a list of values, aka `inject`,
// or `foldl`.
g.reduce=g.foldl=g.inject=k(1),
// The right-associative version of reduce, also known as `foldr`.
g.reduceRight=g.foldr=k(-1),
// Return the first value which passes a truth test. Aliased as `detect`.
g.find=g.detect=function(e,t,n){var r=(O(e)?g.findIndex:g.findKey)(e,t,n);if(void 0!==r&&-1!==r)return e[r]},
...
// Aliased as `all`.
g.every=g.all=function(e,t,n){t=x(t,n);for(var r=!O(e)&&g.keys(e),o=(r||e).length,i=0;i<o;i++){var a=r?r[i]:i;if(!t(e[a],a,e))return!1}return!0},
// Determine if at least one element in the object matches a truth test.
// Aliased as `any`.
g.some=g.any=function(e,t,n){t=x(t,n);for(var r=!O(e)&&g.keys(e),o=(r||e).length,i=0;i<o;i++){var a=r?r[i]:i;if(t(e[a],a,e))return!0}return!1},
// Determine if the array or object contains a given item (using `===`).
// Aliased as `includes` and `include`.
g.contains=g.includes=g.include=function(e,t,n,r){return O(e)||(e=g.values(e)),("number"!=typeof n||r)&&(n=0),g.indexOf(e,t,n)>=0},
...
g.max=function(e,t,n){var o,i,a=-1/0,u=-1/0;if(null==t||"number"==typeof t&&"object"!=r(e[0])&&null!=e)for(var s=0,l=(e=O(e)?e:g.values(e)).length;s<l;s++)null!=(o=e[s])&&o>a&&(a=o);else t=x(t,n),g.each(e,function(e,n,r){((i=t(e,n,r))>u||i===-1/0&&a===-1/0)&&(a=e,u=i)});return a},
// Return the minimum element (or element-based computation).
g.min=function(e,t,n){var o,i,a=1/0,u=1/0;if(null==t||"number"==typeof t&&"object"!=r(e[0])&&null!=e)for(var s=0,l=(e=O(e)?e:g.values(e)).length;s<l;s++)null!=(o=e[s])&&o<a&&(a=o);else t=x(t,n),g.each(e,function(e,n,r){((i=t(e,n,r))<u||i===1/0&&a===1/0)&&(a=e,u=i)});return a},
...
g.sample=function(e,t,n){if(null==t||n)return O(e)||(e=g.values(e)),e[g.random(e.length-1)];var r=O(e)?g.clone(e):g.values(e),o=_(r);t=Math.max(Math.min(t,o),0);for(var i=o-1,a=0;a<t;a++){var u=g.random(a,i),s=r[a];r[a]=r[u],r[u]=s}return r.slice(0,t)},
...
g.toArray=function(e){return e?g.isArray(e)?c.call(e):g.isString(e)?e.match(A):O(e)?g.map(e,g.identity):g.values(e):[]},
// Return the number of elements in an object.
g.size=function(e){return null==e?0:O(e)?e.length:g.keys(e).length},
...
var N=function e(t,n,r,o){for(var i=(o=o||[]).length,a=0,u=_(t);a<u;a++){var s=t[a];if(O(s)&&(g.isArray(s)||g.isArguments(s)))
...
var R=function(e,t,n,r,o){if(!(r instanceof t))return e.apply(n,o);var i=C(e.prototype),a=e.apply(i,o);return g.isObject(a)?a:i};
// Create a function bound to a given object (assigning `this`, and arguments,
// optionally). Delegates to **ECMAScript 5**'s native `Function.bind` if
// available.
g.bind=w(function(e,t,n){if(!g.isFunction(e))throw new TypeError("Bind must be called on a function");var r=w(function(o){return R(e,r,t,this,n.concat(o))});return r}),(
// Partially apply a function by creating a version that has had some of its
// arguments pre-filled, without changing its dynamic `this` context. _ acts
// as a placeholder by default, allowing any combination of arguments to be
// pre-filled. Set `_.partial.placeholder` for a custom placeholder argument.
g.partial=w(function(e,t){var n=g.partial.placeholder;return function r(){for(var o=0,i=t.length,a=Array(i),u=0;u<i;u++)a[u]=t[u]===n?arguments[o++]:t[u];for(;o<arguments.length;)a.push(arguments[o++]);return R(e,r,this,this,a)}})).placeholder=g,
...
var B,F,H=function(e,t,n){return t in n};
// Return a copy of the object only containing the whitelisted properties.
g.pick=w(function(e,t){var n={},r=t[0];if(null==e)return n;g.isFunction(r)?(t.length>1&&(r=b(r,t[1])),t=g.allKeys(e)):(r=H,t=N(t,!1,!1),e=Object(e));for(var o=0,i=t.length;o<i;o++){var a=t[o],u=e[a];r(u,a,e)&&(n[a]=u)}return n}),
...
var i=void 0===e?"undefined":r(e);return("function"===i||"object"===i||"object"==(void 0===t?"undefined":r(t)))&&F(e,t,n,o)},
...
g.isEmpty=function(e){return null==e||(O(e)&&(g.isArray(e)||g.isString(e)||g.isArguments(e))?0===e.length:0===g.keys(e).length)},
...
(h=e[r](t,y)).on("all",function(e,t){
//Auto next source when player load was fail by amiss source.
if(e===c.ERROR&&(t.code===c.PLAYER_FILE_ERROR||5===parseInt(t.code/100))||e===c.NETWORK_UNSTABLE){var r=n.getCurrentQuality();n.setCurrentQuality(r+1)}n.trigger(e,t)})}).then(function(){h.preload(p.getCurrentSources(),e),g.flush(),
