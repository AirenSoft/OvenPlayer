...
/***/79:
/***/function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var r=l(n(12)),o=l(n(78)),a=l(n(0)),i=l(n(6)),u=n(2);function l(e){return e&&e.__esModule?e:{default:e}}t.default=function(e,t,n,l){OvenPlayerConsole.log("CORE loaded. ");var s={};(0,r.default)(s);var d=function(e,t){return a.default.isElement(t)?t:e===u.PROVIDER_DASH?t.getVideoElement():e===u.PROVIDER_HLS?t.media:null}(e,t),c=(0,o.default)(e,t,d,s),f=!1,g=!1,E=u.STATE_IDLE,v=0,y=-1,p=[],O=n.getConfig().image||"";d.playbackRate=d.defaultPlaybackRate=n.getDefaultPlaybackRate();var T=function(e){var t=Math.max(0,y);if(e)for(var r=0;r<e.length;r++)if(e[r].default&&(t=r),n.getQualityLabel()&&e[r].label===n.getQualityLabel())return r;return t},m=function(e){var t=p[y];if(l)l(t,e);else{OvenPlayerConsole.log("source loaded : ",t,"lastPlayPosition : "+e);var n=d.src,r=document.createElement("source");r.src=t.file,r.src!==n?(d.src=p[y].file,
// Do not call load if src was not set. load() will cancel any active play promise.
n&&d.load()):0==e&&d.currentTime>0&&s.seek(e),e>0&&(s.seek(e),s.play()),s.trigger(u.CONTENT_LEVELS,{currentQuality:y}),O&&(d.poster=O)}};return s.getName=function(){return e},s.canSeek=function(){return f},s.setCanSeek=function(e){f=e},s.isSeeking=function(){return g},s.setSeeking=function(e){g=e},s.setState=function(e){if(E!=e){var t=E;switch(e){case u.STATE_COMPLETE:s.trigger(u.PLAYER_COMPLETE);break;case u.STATE_PAUSED:s.trigger(u.PLAYER_PAUSE,{prevState:E});break;case u.STATE_PLAYING:s.trigger(u.PLAYER_PLAY,{prevState:E})}E=e,s.trigger(u.PLAYER_STATE,{prevstate:t,newstate:E})}},s.getState=function(){return E},s.setBuffer=function(e){v=e},s.getBuffer=function(){return v},s.getDuration=function(){return d.duration==1/0||e===u.PROVIDER_DASH&&t.isDynamic()?1/0:d.duration},s.getPosition=function(){return d.currentTime},s.setVolume=function(e){d.volume=e/100},s.getVolume=function(){return 100*d.volume},s.setMute=function(e){return void 0===e?(d.muted=!d.muted,s.trigger(u.CONTENT_MUTE,{mute:d.muted})):(d.muted=e,s.trigger(u.CONTENT_MUTE,{mute:d.muted})),d.muted},s.getMute=function(){return d.muted},s.preload=function(e,t){return y=T(p=e),m(t||0),new i.default(function(e,t){e()})},s.load=function(e){y=T(p=e),m(e.starttime||0)},s.play=function(){s.getState()!==u.STATE_PLAYING&&d.play()},s.pause=function(){s.getState()==u.STATE_PLAYING&&d.pause()},s.seek=function(e){d.currentTime=e},s.setPlaybackRate=function(e){return s.trigger(u.PLAYBACK_RATE_CHANGED,{playbackRate:e}),d.playbackRate=d.defaultPlaybackRate=e},s.getPlaybackRate=function(){return d.playbackRate},s.getQualityLevels=function(){return p.map(function(e,t){return{file:e.file,type:e.type,label:e.label,index:t}})},s.getCurrentQuality=function(){var e=p[y];return{file:e.file,type:e.type,label:e.label,index:y}},s.setCurrentQuality=function(e,t){return y!=e&&(e>-1&&p&&p.length>e?(
//that.pause();
