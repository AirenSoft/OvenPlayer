...
/***/},
/***/62:
/***/function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0});a(r(61));var n=a(r(4)),i=r(8),o=a(r(1));function a(e){return e&&e.__esModule?e:{default:e}}t.default=function(e,t,r){t=t;var a="",s="",c={iceServers:[{urls:"stun:stun.l.google.com:19302"}]},d={},p="";function u(e){OvenPlayerConsole.log("WebRTC Loader closePeear()"),a&&(OvenPlayerConsole.log("Closing websocket connection..."),OvenPlayerConsole.log("Send Signaling : Stop."),a.send(JSON.stringify({command:"stop"})),a.close(),a=null),s&&(OvenPlayerConsole.log("Closing peer connection..."),p&&clearTimeout(p),s.close(),s=null),e&&r(e)}return function(){var e=window.onbeforeunload;window.onbeforeunload=function(t){e&&e(t),OvenPlayerConsole.log("This calls auto when browser closed."),u()}}(),d.connect=function(){return function(){OvenPlayerConsole.log("WebRTCLoader connecting...");var r=function(e,t,r){t.setLocalDescription(r).then(function(){
// my SDP created.
var r=t.localDescription;OvenPlayerConsole.log("Local SDP",r),//test code
// my sdp send to server.
a.send(JSON.stringify({id:e,command:"answer",sdp:r}))}).catch(function(e){u({code:i.PLAYER_WEBRTC_SET_LOCAL_DESC_ERROR,reason:"setLocalDescription error occurred",message:"setLocalDescription error occurred",error:e})})};return new n.default(function(n,d){OvenPlayerConsole.log("WebRTCLoader url : "+t),(a=new WebSocket(t)).onopen=function(){a.send(JSON.stringify({command:"request_offer"}))},a.onmessage=function(t){var d=JSON.parse(t.data);if(d.error)return OvenPlayerConsole.log(d.error),!1;if(d.list)OvenPlayerConsole.log("List received");else if(d.id){if(s||((s=new RTCPeerConnection(c)).onicecandidate=function(e){e.candidate&&(OvenPlayerConsole.log("WebRTCLoader send candidate to server : "+e.candidate),a.send(JSON.stringify({id:d.id,command:"candidate",candidates:[e.candidate]})))},s.onnegotiationneeded=function(){s.createOffer().then(function(e){OvenPlayerConsole.log("createOffer : success"),r(d.id,s,e)}).catch(function(e){u({code:i.PLAYER_WEBRTC_CREATE_ANSWER_ERROR,reason:"createOffer error occurred",message:"createOffer error occurred",error:error})})},s.onaddstream=function(t){OvenPlayerConsole.log("stream received.");
// stream received.
var r=[],
//8 statistics. every 2 seconds
a=0,c=0,d=0;!function t(){p=setTimeout(function(){if(!s)return!1;s.getStats().then(function(n){OvenPlayerConsole.log(n),n.forEach(function(t){"inbound-rtp"!==t.type||t.isRemote||(OvenPlayerConsole.log(t),
//(state.packetsLost - prevPacketsLost) is real current lost.
r.push(parseInt(t.packetsLost)-parseInt(a)),r.length>8&&(r=r.slice(r.length-8,r.length),c=o.default.reduce(r,function(e,t){return e+t},0)/8,OvenPlayerConsole.log("Last8 LOST PACKET AVG  : "+c,t.packetsLost,r),c>20?3==++d&&(OvenPlayerConsole.log("NETWORK UNSTABLED!!! "),e.trigger(i.NETWORK_UNSTABLED),d=0):d=0),a=t.packetsLost)}),t()})},2e3)}(),n(t.stream)}),d.sdp&&
//Set remote description when I received sdp from server.
s.setRemoteDescription(new RTCSessionDescription(d.sdp)).then(function(){"offer"===s.remoteDescription.type&&
// This creates answer when I received offer from publisher.
s.createAnswer().then(function(e){OvenPlayerConsole.log("createAnswer : success"),r(d.id,s,e)}).catch(function(e){u({code:i.PLAYER_WEBRTC_CREATE_ANSWER_ERROR,reason:"createAnswer error occurred",message:"createAnswer error occurred",error:e})})}).catch(function(e){u({code:i.PLAYER_WEBRTC_SET_REMOTE_DESC_ERROR,reason:"setRemoteDescription error occurred",message:"setRemoteDescription error occurred",error:e})}),d.candidates)
// This receives ICE Candidate from server.
for(var l=0;l<d.candidates.length;l++)d.candidates[l]&&d.candidates[l].candidate&&s.addIceCandidate(new RTCIceCandidate(d.candidates[l])).then(function(){OvenPlayerConsole.log("addIceCandidate : success")}).catch(function(e){u({code:i.PLAYER_WEBRTC_ADD_ICECANDIDATE_ERROR,reason:"addIceCandidate error occurred",message:"addIceCandidate error occurred",error:e})})}else OvenPlayerConsole.log("ID must be not null")},a.onerror=function(e){u({code:i.PLAYER_WEBRTC_WS_ERROR,reason:"websocket error occured",message:"websocket error occurred",error:e}),d(e)}})}()},d.destroy=function(){u()},d}}}]);
