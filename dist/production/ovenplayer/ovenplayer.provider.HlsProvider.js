 ...
 */(r(59)),i=r(8);t.default=function(e,t){var r="",o={},a="",s="";try{(r=new Hls({debug:!1})).attachMedia(e),o=(0,n.default)(i.PROVIDER_HLS,e,t,function(t,n){OvenPlayerConsole.log("HLS : source loaded : ",t,"lastPlayPosition : "+n),r.loadSource(t.file),n>0&&(e.seek(n),a())}),OvenPlayerConsole.log("HLS PROVIDER LOADED."),a=o.super("play"),s=o.super("destroy"),o.destroy=function(){r.destroy(),r=null,OvenPlayerConsole.log("HLS : PROVIDER DESTROUYED."),s()}}catch(e){throw new Error(e)}return o}},
/***/12:
/***/function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n=s(r(59)),i=r(2),o=s(r(62)),a=r(8);s(r(4));function s(e){return e&&e.__esModule?e:{default:e}}
/**
...
// Safari.
r.browser="safari",r.version=o(t.userAgent,/AppleWebKit\/(\d+)\./,1)}return r}}},{}]},{},[3])(3)})}).call(this,r(14))
/***/},
/***/62:
/***/function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0});o(r(61));var n=o(r(4)),i=r(8);function o(e){return e&&e.__esModule?e:{default:e}}t.default=function(e,t){e=e;var r="",o="",a={iceServers:[{urls:"stun:stun.l.google.com:19302"}]},s={};function c(e){OvenPlayerConsole.log("WebRTC Loader closePeear()"),r&&(OvenPlayerConsole.log("Closing websocket connection..."),OvenPlayerConsole.log("Send Signaling : Stop."),r.send(JSON.stringify({command:"stop"})),r.close(),r=null),o&&(OvenPlayerConsole.log("Closing peer connection..."),o.close(),o=null),e&&t(e)}return function(){var e=window.onbeforeunload;window.onbeforeunload=function(t){e&&e(t),OvenPlayerConsole.log("This calls auto when browser closed."),c()}}(),s.connect=function(){return function(){OvenPlayerConsole.log("WebRTCLoader connecting...");var t=function(e,t,n){t.setLocalDescription(n).then(function(){
// my SDP created.
var n=t.localDescription;OvenPlayerConsole.log("Local SDP",n),//test code
// my sdp send to server.
r.send(JSON.stringify({id:e,command:"answer",sdp:n}))}).catch(function(e){c({code:i.PLAYER_WEBRTC_SET_LOCAL_DESC_ERROR,reason:"setLocalDescription error occurred",message:"setLocalDescription error occurred",error:e})})};return new n.default(function(n,s){OvenPlayerConsole.log("WebRTCLoader url : "+e),(r=new WebSocket(e)).onopen=function(){r.send(JSON.stringify({command:"request_offer"}))},r.onmessage=function(e){var s=JSON.parse(e.data);if(s.error)return OvenPlayerConsole.log(s.error),!1;if(s.list)OvenPlayerConsole.log("List received");else if(s.id){if(o||((o=new RTCPeerConnection(a)).onicecandidate=function(e){e.candidate&&(OvenPlayerConsole.log("WebRTCLoader send candidate to server : "+e.candidate),r.send(JSON.stringify({id:s.id,command:"candidate",candidates:[e.candidate]})))},o.onnegotiationneeded=function(){o.createOffer().then(function(e){OvenPlayerConsole.log("createOffer : success"),t(s.id,o,e)}).catch(function(e){c({code:i.PLAYER_WEBRTC_CREATE_ANSWER_ERROR,reason:"createOffer error occurred",message:"createOffer error occurred",error:error})})},o.onaddstream=function(e){OvenPlayerConsole.log("stream received."),
// stream received.
n(e.stream)}),s.sdp&&
//Set remote description when I received sdp from server.
o.setRemoteDescription(new RTCSessionDescription(s.sdp)).then(function(){"offer"===o.remoteDescription.type&&
// This creates answer when I received offer from publisher.
o.createAnswer().then(function(e){OvenPlayerConsole.log("createAnswer : success"),t(s.id,o,e)}).catch(function(e){c({code:i.PLAYER_WEBRTC_CREATE_ANSWER_ERROR,reason:"createAnswer error occurred",message:"createAnswer error occurred",error:e})})}).catch(function(e){c({code:i.PLAYER_WEBRTC_SET_REMOTE_DESC_ERROR,reason:"setRemoteDescription error occurred",message:"setRemoteDescription error occurred",error:e})}),s.candidates)
// This receives ICE Candidate from server.
for(var d=0;d<s.candidates.length;d++)s.candidates[d]&&s.candidates[d].candidate&&o.addIceCandidate(new RTCIceCandidate(s.candidates[d])).then(function(){OvenPlayerConsole.log("addIceCandidate : success")}).catch(function(e){c({code:i.PLAYER_WEBRTC_ADD_ICECANDIDATE_ERROR,reason:"addIceCandidate error occurred",message:"addIceCandidate error occurred",error:e})})}else OvenPlayerConsole.log("ID must be not null")},r.onerror=function(e){c({code:i.PLAYER_WEBRTC_WS_ERROR,reason:"websocket error occured",message:"websocket error occurred",error:e}),s(e)},r.onclose=function(e){c({code:i.PLAYER_WEBRTC_WS_CLOSED,reason:"websocket closed",message:"websocket closed",error:e}),s(e)}})}()},s.destroy=function(){c()},s}}}]);
