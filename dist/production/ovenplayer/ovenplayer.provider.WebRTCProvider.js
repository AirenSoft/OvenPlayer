...
/***/16:
/***/function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n=c(r(76)),i=c(r(78)),a=c(r(82)),o=(c(r(6)),r(4)),s=r(2);function c(e){return e&&e.__esModule?e:{default:e}}
/**
...
/***/},
/***/76:
/***/function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n=r(28),i=r(2);t.default=function(e,t){var r={},a=e.getAttribute("data-parent-id"),o="",s=(0,n.getBrowser)();OvenPlayerConsole.log("MediaManager loaded. browserType : "+s);return r.create=function(){return OvenPlayerConsole.log("MediaManager createElement()"),o&&r.destroy(),function(){if(t!==i.PROVIDER_RTMP)(o=document.createElement("video")).setAttribute("disableRemotePlayback",""),o.setAttribute("webkit-playsinline",""),o.setAttribute("playsinline",""),e.appendChild(o);else{var r=void 0,n=void 0,s=void 0,c=void 0,d=void 0;(r=document.createElement("param")).setAttribute("name","movie"),r.setAttribute("value","./ovenplayer/OvenPlayerFlash.swf"),(n=document.createElement("param")).setAttribute("name","flashvars"),
//playerId uses SWF for ExternalInterface.call().
n.setAttribute("value","playerId="+a),(s=document.createElement("param")).setAttribute("name","allowscriptaccess"),s.setAttribute("value","always"),(c=document.createElement("param")).setAttribute("name","allowfullscreen"),c.setAttribute("value","true"),(d=document.createElement("param")).setAttribute("name","quality"),d.setAttribute("value","height"),(o=document.createElement("object")).setAttribute("type","application/x-shockwave-flash"),o.setAttribute("data","./ovenplayer/OvenPlayerFlash.swf"),o.setAttribute("id",a+"-flash"),o.setAttribute("name",a+"-flash"),o.setAttribute("width","100%"),o.setAttribute("height","100%"),o.appendChild(n),o.appendChild(s),o.appendChild(c),
/*if(browserType !== "ie"){
                mediaElement.appendChild(inner);
            }*/
e.appendChild(o)}return o}()},r.destroy=function(){OvenPlayerConsole.log("MediaManager removeElement()"),e.removeChild(o),o=null},r}},
/***/77:
...
var L,D,x=n.parseRtpParameters(o);h||(L=n.getIceParameters(o,f),(D=n.getDtlsParameters(o,f)).role="client"),k=n.parseRtpEncodingParameters(o);var M=n.parseRtcpParameters(o),I=n.matchPrefix(o,"a=end-of-candidates",f).length>0,A=n.matchPrefix(o,"a=candidate:").map(function(e){return n.parseCandidate(e)}).filter(function(e){return 1===e.component});if(
// Check if we can use BUNDLE and dispose transports.
("offer"===i.type||"answer"===i.type)&&!h&&v&&d>0&&a.transceivers[d]&&(a._disposeIceAndDtlsTransports(d),a.transceivers[d].iceGatherer=a.transceivers[0].iceGatherer,a.transceivers[d].iceTransport=a.transceivers[0].iceTransport,a.transceivers[d].dtlsTransport=a.transceivers[0].dtlsTransport,a.transceivers[d].rtpSender&&a.transceivers[d].rtpSender.setTransport(a.transceivers[0].dtlsTransport),a.transceivers[d].rtpReceiver&&a.transceivers[d].rtpReceiver.setTransport(a.transceivers[0].dtlsTransport)),"offer"!==i.type||h)"answer"!==i.type||h||(E=(S=a.transceivers[d]).iceGatherer,R=S.iceTransport,P=S.dtlsTransport,b=S.rtpReceiver,_=S.sendEncodingParameters,O=S.localCapabilities,a.transceivers[d].recvEncodingParameters=k,a.transceivers[d].remoteCapabilities=x,a.transceivers[d].rtcpParameters=M,A.length&&"new"===R.state&&(!m&&!I||v&&0!==d?A.forEach(function(e){c(S.iceTransport,e)}):R.setRemoteCandidates(A)),v&&0!==d||("new"===R.state&&R.start(E,L,"controlling"),"new"===P.state&&P.start(D)),a._transceive(S,"sendrecv"===y||"recvonly"===y,"sendrecv"===y||"sendonly"===y),
// TODO: rewrite to use http://w3c.github.io/webrtc-pc/#set-associated-remote-streams
!b||"sendrecv"!==y&&"sendonly"!==y?
// FIXME: actually the receiver should be created later.
delete S.rtpReceiver:(w=b.track,C?(s[C.stream]||(s[C.stream]=new e.MediaStream),r(w,s[C.stream]),u.push([w,b,s[C.stream]])):(s.default||(s.default=new e.MediaStream),r(w,s.default),u.push([w,b,s.default]))));else{(S=a.transceivers[d]||a._createTransceiver(l)).mid=T,S.iceGatherer||(S.iceGatherer=a._createIceGatherer(d,v)),A.length&&"new"===S.iceTransport.state&&(!I||v&&0!==d?A.forEach(function(e){c(S.iceTransport,e)}):S.iceTransport.setRemoteCandidates(A)),O=e.RTCRtpReceiver.getCapabilities(l),
// filter RTX until additional stuff needed for RTX is implemented
// in adapter.js
t<15019&&(O.codecs=O.codecs.filter(function(e){return"rtx"!==e.name})),_=S.sendEncodingParameters||[{ssrc:1001*(2*d+2)}];
// TODO: rewrite to use http://w3c.github.io/webrtc-pc/#set-associated-remote-streams
var j,N=!1;if("sendrecv"===y||"sendonly"===y){if(N=!S.rtpReceiver,b=S.rtpReceiver||new e.RTCRtpReceiver(S.dtlsTransport,l),N)w=b.track,
// FIXME: does not work with Plan B.
C&&"-"===C.stream||(C?(s[C.stream]||(s[C.stream]=new e.MediaStream,Object.defineProperty(s[C.stream],"id",{get:function(){return C.stream}})),Object.defineProperty(w,"id",{get:function(){return C.track}}),j=s[C.stream]):(s.default||(s.default=new e.MediaStream),j=s.default)),j&&(r(w,j),S.associatedRemoteMediaStreams.push(j)),u.push([w,b,j])}else S.rtpReceiver&&S.rtpReceiver.track&&(S.associatedRemoteMediaStreams.forEach(function(t){var r=t.getTracks().find(function(e){return e.id===S.rtpReceiver.track.id});r&&function(t,r){r.removeTrack(t),r.dispatchEvent(new e.MediaStreamTrackEvent("removetrack",{track:t}))}(r,t)}),S.associatedRemoteMediaStreams=[]);S.localCapabilities=O,S.remoteCapabilities=x,S.rtpReceiver=b,S.rtcpParameters=M,S.sendEncodingParameters=_,S.recvEncodingParameters=k,
